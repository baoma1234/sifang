...
$mchid = "10006";  //商户后台API管理获取
$Md5key = "dl0t18cttb0kkigl273x9pnqbwx0279w";//商户后台API管理获取
$out_trade_no = date("YmdHis").mt_rand(1000,9999);    //订单号
$_POST['out_trade_no'] = $out_trade_no;
$money =  $_POST["money"];    //交易金额
$_POST['mchid'] = $mchid;
if(empty($mchid)||empty($_POST['money'])|| empty($_POST['accountname']) 
...
$tjurl = "http://zy.bugattl.com/Payment_Dfpay_usdtadd.html";   //提交地址
ksort($_POST);
//var_dump($_POST);die;
$md5str = "";
