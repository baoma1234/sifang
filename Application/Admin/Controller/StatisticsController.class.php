...
class StatisticsController extends BaseController
{
    ...
    public function channelFinance()
    {
        ...
        foreach ($productList as $k => $v) {
            ...
            $productList[$k]['success_rate'] = bcdiv($productList[$k]['success_count'], $productList[$k]['count'], 2) * 100;
        }
    ...
    public function productChannelFinance()
    {
        ...
        foreach($list as $k => $v) {
            ...
            $list[$k]['success_rate'] = $list[$k]['count']>0?bcdiv($list[$k]['success_count'],$list[$k]['count'], 2) * 100 : 0;//成功率
        }
        $this->assign('list', $list);
