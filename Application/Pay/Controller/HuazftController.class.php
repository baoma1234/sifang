...
class HuazftController extends PayController {
    ...
    public function Pay($array) {
        ...
        $notifyurl = $this->_site . 'Pay_Huazft_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_Huazft_callbackurl.html'; //返回通知
...
echo $html_text;
    ...
    public function notifyurl() {
    	 file_put_contents(dirname( __FILE__ ).'/notifylog/~NOTIFY-log-'. date('Y-m-d',$_SERVER['REQUEST_TIME']) . '.log','huazhifu2：'.http_build_query($_REQUEST)."\n", FILE_APPEND);
